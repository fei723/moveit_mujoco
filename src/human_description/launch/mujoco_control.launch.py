...
def robot_nodes_spawner(context: LaunchContext, robot_id, command_interface, load_groups, runtime_config_package, controllers_file, use_sim_time, log_level, mujoco_scene_file=None):
   ...
   # Configure ROS nodes for launch
    ...
    robot_state_publisher_spawner_opaque_function = OpaqueFunction(
        function=robot_nodes_spawner, args=[
            robot_id, command_interface, load_groups, runtime_config_package, controllers_file, use_sim_time, log_level, mujoco_scene_file]
    )
